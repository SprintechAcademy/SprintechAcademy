      ...
      <div className="container">
        <div className="footer__grid">
          <div className="footer__col footer__col--brand">
            <a href="#" className="footer__logo"><LandingLogo /></a>
            <p className="footer__desc">{t.desc}</p>
            <a href="/login" className="btn btn--purple footer__cta">{t.cta}</a>
            <div className="footer__social">
              <a href="https://www.instagram.com/sprintechacademy" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
