...
export default function Mentalidad() {
  ...
  return (
    <section className="mentalidad" ref={ref as React.RefObject<HTMLElement>}>
      <div className="container">
        <div className="mentalidad__cols">
          <div className="mentalidad__left anim-ready" style={{ '--delay': '0s' } as React.CSSProperties}>
          ...
          <div className="mentalidad__right anim-ready" style={{ '--delay': '0.15s' } as React.CSSProperties}>
        ...
        <div className="mentalidad__stats anim-ready" style={{ '--delay': '0.25s' } as React.CSSProperties}>
          {t.stats.map((stat) => (
