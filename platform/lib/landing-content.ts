          ...
          programs: [
            {
              ...
              benefits: [
                { title: 'Conocimiento de plataformas técnicas', desc: 'Conoce herramientas como CM360 y DV360, utilizadas por agencias y equipos de AdTech para gestionar campañas digitales.' },
                { title: 'Perfil listo para el mercado laboral', desc: 'Obtén un CV optimizado, un portafolio profesional y preparación para entrevistas en inglés orientadas a agencias globales.' },
                { title: 'Acceso a oportunidades globales', desc: 'Forma parte de la comunidad de Sprinters y accede a recursos exclusivos, networking y vacantes compartidas por empresas y agencias internacionales.' },
              ],
              cta:     'Ver Ad Operations Sprint',
              ctaHref: '/retos/ad-operations-sprint',
              price:   'Desde 600 COP',
            },
          ],
          ...
          programs: [
            {
              ...
              benefits: [
                { title: 'Technical platform knowledge', desc: 'Learn tools like CM360 and DV360, used by agencies and AdTech teams to manage digital campaigns.' },
                { title: 'Job-market-ready profile', desc: 'Get an optimized CV, a professional portfolio, and preparation for English interviews targeting global agencies.' },
                { title: 'Access to global opportunities', desc: 'Join the Sprinters community and access exclusive resources, networking, and vacancies shared by international companies and agencies.' },
              ],
