      ...
      tabs: [
        {
          ...
          ctas: [
            { label: 'Programa Ad Ops Sprinter — Desde USD 200', href: '#registro', variant: 'btn--accent' },
          ],
        },
        {
        ...
        },
        {
          ...
          ctas: [
            { label: 'Unirme a la comunidad', href: '#', variant: 'btn--primary' },
          ],
        },
      ],
    },
      ...
      tabs: [
        {
          ...
          ctas: [
            { label: 'Ad Ops Sprinter Program — From USD 200', href: '#registro', variant: 'btn--accent' },
          ],
        },
        {
        ...
        },
        {
          ...
          ctas: [
            { label: 'Join the community', href: '#', variant: 'btn--primary' },
          ],
        },
      ],
    },
